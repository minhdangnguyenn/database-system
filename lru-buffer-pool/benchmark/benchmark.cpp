...
void write_csv_row(std::ofstream &csv, const std::string &name,
                   ...
                   int key_range, long long ms, long long ns_per_op) {
    csv << name << "," << type << "," << capacity << "," << operations << ","
        << key_range << "," << ms << "," << ns_per_op << "\n";
}
...
// ─────────────────────────────────────────
//  BENCHMARK — O(1) LRUReplacer
// ─────────────────────────────────────────
void benchmark(const std::string &name, int capacity, int operations,
               int key_range, std::ofstream &csv) {
    LRUReplacer replacer;
    BufferPool cache(capacity, &replacer);
...
// ─────────────────────────────────────────
//  BENCHMARK — NAIVE LRUReplacerNaive
// ─────────────────────────────────────────
void benchmark_naive(const std::string &name, int capacity, int operations,
                     int key_range, std::ofstream &csv) {
...
//  COMPARE BOTH
// ─────────────────────────────────────────
void compare(const std::string &name, int capacity, int operations,
             int key_range, std::ofstream &csv) {
